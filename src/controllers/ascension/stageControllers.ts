...
// Returns all 9 stages with their material requirements joined in.
export const getStagesForEntity = async (
  ...
  try {
    ...
    console.error("Error getting ascension stages:", error);
    throw error;
  }
};
...
export const getStageById = async (
  ...
  try {
    ...
    console.error("Error getting ascension stage:", error);
    throw error;
  }
};
...
export const levelToStageNumber = async (
  ...
  try {
    ...
    console.error("Error converting level to stage:", error);
    throw error;
  }
};
...
export const createAscensionStage = async (
  ...
  try {
    ...
    console.error("Error creating ascension stage:", error);
    throw error;
  }
};

// UPDATE STAGE
// Only cost fields are editable after creation
export const updateAscensionStage = async (
  ...
  try {
    ...
    console.error("Error updating ascension stage:", error);
    throw error;
  }
};

// DELETE STAGE
// Cascades to ascension_requirements via ON DELETE CASCADE in schema.
export const deleteAscensionStage = async (id: number): Promise<boolean> => {
  try {
    ...
    console.error("Error deleting ascension stage:", error);
    throw error;
  }
};
