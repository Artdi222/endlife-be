...
// Returns full skill tree: skills → levels → requirements in 3 queries.
export const getSkillsForCharacter = async (
  ...
  try {
    ...
    console.error("Error getting skills for character:", error);
    throw error;
  }
};
...
// DELETE SKILL
// Cascades to skill_levels → skill_level_requirements via ON DELETE CASCADE.
